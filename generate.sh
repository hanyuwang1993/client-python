...
wget https://raw.githubusercontent.com/grafeas/grafeas/master/proto/v1beta1/swagger/project.swagger.json -O project.swagger.json
...
java -jar ./swagger-codegen-cli.jar generate  -i ./project.swagger.json  -l python -o ./ -c ./config.py.json
